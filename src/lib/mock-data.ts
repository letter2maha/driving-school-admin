...
export const mockApplications: ApplicationWithDetails[] = [
  {
    ...
    instructor_profile: {
      id: '1',
      expertise: ['Manual', 'Automatic'],
      experience_years: 5,
      bio: 'Experienced driving instructor with 5+ years of experience',
      manual_price_min: 25,
      manual_price_max: 35,
      automatic_price_min: 30,
      automatic_price_max: 40,
      expertise_keywords: ['patient', 'experienced', 'city driving'],
      car_details: 'Manual Ford Fiesta - Clean and well-maintained',
      created_at: '2024-01-15T10:00:00Z',
      updated_at: '2024-01-15T10:00:00Z'
    },
    verification_status: {
  ...
  },
  {
    ...
    instructor_profile: {
      ...
      manual_price_min: 22,
      manual_price_max: 32,
      automatic_price_min: 27,
      automatic_price_max: 37,
      expertise_keywords: ['patient', 'nervous drivers', 'confident'],
      car_details: 'Automatic Vauxhall Corsa - Comfortable and modern',
      created_at: '2024-01-16T11:00:00Z',
      updated_at: '2024-01-16T11:00:00Z'
    },
    verification_status: {
